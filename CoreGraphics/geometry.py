...
__all__ = [
    ...
    'CGRectIntegral', 'CGRectIntersection', 'CGRectOffset', 'CGRectStandardize',
    'CGRectUnion', 'CGPointEqualToPoint', 'CGSizeEqualToSize',
    'CGRectEqualToRect', 'CGRectIntersectsRect', 'CGRectContainsPoint',
    'CGRectContainsRect', 'CGRectGetMinX', 'CGRectGetMinY', 'CGRectGetMidX',
    'CGRectGetMidY', 'CGRectGetMaxX', 'CGRectGetMaxY', 'CGRectGetWidth',
    'CGRectGetHeight', 'CGRectIsEmpty', 'CGRectIsNull', 'CGRectIsInfinite'
]
